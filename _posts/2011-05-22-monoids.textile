...
sortBy (comparing sum `mappend` comparing length `mappend` compare) [[1,2,3], [3,2,1], [6], [1,1,1,1,1,1], [7], [1,1,1,1]]

{% endhighlight %}

returning [[1,1,1,1],[6],[1,2,3],[3,2,1],[1,1,1,1,1,1],[7]]. As you can see, the list was sorted by sum, then length, then by comparison (hence [1,2,3] coming before [3,2,1]). Now consider how much code it would have taken to do this without using monoids.
